...
const SingleProduct = (  ) => {
    ...
    const {id, title, description, price, discountPercentage, rating, thumbnail, images} = product || {};
    return (
        <div className="w-2/5  mx-auto my-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img className="p-8 rounded-t-lg h-screen" src={thumbnail} alt="product image" />
    </a>
    <div className="px-5 pb-5">
        <a href="#">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{title}</h5>
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{description}</h5>
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{discountPercentage}</h5>
        </a>
